        ...
        <div class="p-20 w-1/3 h-auto bg-[#362e30] opacity-60 rounded-xl">
            ...
            <form action="">
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" class="w-full rounded-lg text-lg px-2 hover:border border-blue-500">
                    </div>
                </div>
                <div class="mb-3">
                    <div>
                    ...
                    <div>
                        <input type="password" class="w-full rounded-lg text-lg px-2 hover:border border-blue-500">
                    </div>
                </div>
                <div class="flex justify-center mt-6">
                    <button class="text-xl bg-[#e9eef1] px-8 py-2 rounded-xl font-semibold tracking-wide hover:bg-[#6ba8d7] du">Login</button>
                </div>
            </form>
        </div>
    </div>
