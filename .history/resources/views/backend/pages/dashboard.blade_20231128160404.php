...
@section('main')
    ...
    <div class="mt-4 grid grid-cols-2 gap-5">
        <div class="bg-[#283046] rounded-lg py-3">
            ...
            <div class="mt-6">
                <div
                    class="w-full bg-[#343d55] text-[#caccd1] tracking-wide font-medium grid grid-cols-4 pl-4 gap-2 py-3">
                    <div>
                        <p class="text-base">TÊN</p>
                    </div>
                    <div>
                        <p class="text-base">SỐ TIỀN</p>
                    </div>
                    <div>
                        <p class="text-base">TRẠNG THÁI</p>
                    </div>
                    <div>
                        <p>NGÀY</p>
                    </div>
