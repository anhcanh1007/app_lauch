    ...
    <div class="mt-4 grid grid-cols-2 gap-5">
        <div class="bg-[#283046] rounded-lg py-3">
            ...
            <div class="mt-6">
                ...
                <div
                    class="w-full bg-[#283046] tracking-wide font-medium grid grid-cols-4 pl-4 gap-2 py-3 text-sm border-solid border-b-[1px] border-gray-400">
                    <div>
                ...
                <div class="w-full bg-[#283046] tracking-wide font-medium grid grid-cols-4 pl-4 gap-2 py-3 text-sm">
                    <div>
                        <p class="text-[#7166ec]">@themach</p>
                    </div>
                    <div>
