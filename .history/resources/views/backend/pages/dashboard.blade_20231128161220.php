    ...
    <div class="mt-4 grid grid-cols-2 gap-5">
        <div class="bg-[#283046] rounded-lg py-3">
            ...
            <div class="mt-6">
                ...
                <div
                    class="w-full bg-[#283046] tracking-wide font-medium grid grid-cols-4 pl-4 gap-2 py-3 text-sm border-b-[1px] border-gray-400 hover:bg-[#2f3556] duration-100">
                    <div>
                        <p class="text-[#7166ec]">@themach</p>
                    </div>
                    <div>
                        <p class="text-[#28c36e]">100 USDT</p>
                    </div>
                    <div class="pl-2">
                        <p class="text-[#28c36e]">Đã duyệt</p>
                    </div>
                    <div class="pl-2">
                        <p class="text-[#caccd1]">09</p>
                    </div>
                </div>
                <div
                    class="w-full bg-[#283046] tracking-wide font-medium grid grid-cols-4 pl-4 gap-2 py-3 text-sm border-b-[1px] border-gray-400">
                    <div>
                        <p class="text-[#7166ec]">@themach</p>
                    </div>
                    <div>
