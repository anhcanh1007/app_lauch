            ...
            <table class="w-full border-collapse">
                ...
                @foreach ($users as $user)
                    <tbody class="bg-[#242b3d]">
                        ...
                        <td class="p-3 border border-gray-500">{{ $user->balance }}</td>
                        <td class="p-3 border border-gray-500">{{ $user->interest_balance }}</td>
                        <td class="p-3 border border-gray-500">asdfasdf</td>
                        <td class="p-3 border border-gray-500">{{ $user->status == 1 ? 'Hoạt động' : 'Không hoạt động' }}
                        </td>
                    </tbody>
                @endforeach
            </table>
