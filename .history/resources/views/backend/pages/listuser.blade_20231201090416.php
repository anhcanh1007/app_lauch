            ...
            <table class="w-full border-collapse">
                ...
                @foreach ($users as $user)
                    <tbody class="bg-[#242b3d]">
                        ...
                        <td class="p-3 border border-gray-500 text-[#caccd1]">asdfasdf</td>
                        <td class="p-3 border border-gray-500"><p class="text-gren">{{ $user->status == 1 ? 'Hoạt động' : 'Không hoạt động' }}</p>
                        </td>
                    </tbody>
                @endforeach
            </table>
