...
@section('main')
    <div class="px-32">
        ...
        <div class="mt-20 grid grid-cols-2 gap-5">
            ...
            <div class="">
                <div class="mb-4">
                    <h1 class="text-black text-4xl font-semibold tracking-wide">About Or Business</h1>
                </div>
                <div class="mb-6">
                    <p class="tracking-wide">Tradex10 is a cutting-edge business that has harnessed the power of AI
                        technology and expert trading
                ...
                <div class="mb-8 text-lg tracking-wide">
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        <i class="fas fa-check mr-2"></i><span>Add: 29 Truong Chinh, Vinh, Nghe An, Viet Nam</span>
                    </div>
                </div>
                <div>
                    <button class="bg-[#cc0c39] px-6 py-3 rounded-xl text-white font-semibold text-xl">Contact Us
                        -></button>
                </div>
            </div>
        ...
        <div class="mt-20">
            <div>
                ...
                <div>
                    <p>Tradex10 company is a crypto and commodities trading company founded by a group of experienced surfers and technology experts. With the combination of these two areas, Tradex10 has developed cutting-edge technologies, including scalping trading bots and artificial intelligence (AI), to create smart and efficient trading strategies. Thanks to the combination of people and technology, Tradex10 is able to trade crypto assets, commodities and currency pairs with high speed and accuracy, thereby bringing profits to its clients. me. Tradex10's team of experts always monitor market trends and use technical analysis tools to make accurate and timely trading decisions. With the commitment to bring the highest benefits to customers, Tradex10 has become one of the most reputable and reliable crypto and commodity trading companies in the market.</p>
                </div>
            </div>
        </div>
    </div>
