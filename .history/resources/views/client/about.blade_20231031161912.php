...
@section('main')
    <div class="px-32">
        ...
        <div class="mt-20 mb-20 px-20 text-black tracking-wide font-semibold">
            <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4">
                <div class="flex justify-between" id="what-tradex">
                    <h1>What is Tradex10? What did we do to make huge profits?</h1>
                    <h1>-</h1>
                </div>

            </div>
            <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone-tradex" style="dis">
