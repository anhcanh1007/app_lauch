...
@section('main')
    <div class="px-32">
        ...
        <div class="mt-20 grid grid-cols-2 gap-5">
            ...
            <div class="">
                ...
                <div class="mb-8 text-lg tracking-wide">
                    ...
                    <div class="mt-2">
                        <i class="fas fa-check mr-2"></i><span>Add: 14 Uretara Drive,Katikati 3129, New Zealand</span>
                    </div>
                </div>
                <div>
        ...
        <div class="mt-20 mb-20 px-20 text-black tracking-wide font-semibold">
            ...
            <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone-tradex"
                ...
                <p>Tradex10 company is a crypto and commodities trading company founded by a group of experienced
                    ...
                    create smart and efficient trading strategies. Thanks to the combination of people and technology,
                    ...
                    market trends and use technical analysis tools to make accurate and timely trading decisions. With
            ...
            <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4 cursor-pointer mt-5">
                <div id="what-tradex" onclick="toggleDiv()">
                    <h1>Is Tradex10 a legit company? Information about</h1>
                </div>
            </div>
            <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone-tradex"
                style="display: none">
                <p>Tradex10 is a legal company in New Zealand and is registered as Tradex Group Limited.
                    Company number: 1262923
                    Address: 14 Uretara Drive, Katikati 3129, New Zealand
                    Email: info@tradex10.com</p>
            </div>
        </div>
    </div>
@endsection
