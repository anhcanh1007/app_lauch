    ...
    <div class="flex justify-center items-center bg-slate-300 w-full bg-cover h-screen"
        ...
        <div class="w-1/2 bg-[#ffffff] px-16 py-16 rounded-xl">
            ...
            <div class="mt-8">
                <form action="">
                    <div class="mb-3">
                        <p class="text- mb-2">Your email or username</p>
                    ...
                    <div class="mb-3">
                        <p class="text- mb-2">Your Password</p>
                        <input class="border border-gray-800 w-full rounded-xl text-base px-5 py-2 hover:border-blue-900"
                    ...
                    <div class="flex justify-center">
                        <button
                            class="bg-[#7e29e7] px-10 py-3 text- font-medium rounded-xl tracking-wide text-white hover:bg-[#5d87ff] duration-300">Log
                            In</button>
                    </div>
                </form>
            </div>
