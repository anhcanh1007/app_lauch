            ...
            <div class="mt-8">
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror --}}
                        @if ($errors->any())
                            <div><i class="text-xs text-red-500 tracking-wide font-medium">{{ $errors->first() }}</i></div>
                        @endif
                    </div>
                    <div class="flex justify-between mb-5">
                        ...
                        <div>
                            <p
                                class="text-base font-medium underline decoration-dotted hover:text-blue-900 duration-200 cursor-pointer"><a href="">Forgot Password?</a>
                                </p>
                        </div>
                    </div>
