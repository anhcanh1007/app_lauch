                    ...
                    <form action="{{ route('user.update_profile', [$user->id]) }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-10">
                            <div class="mb-2 col-span-1">
                                ...
                                <div class="w-full">
                                    <input type="text" name="first_name" class="w-full bg-[#8e9bb2] p-2 rounded-xl" value="{{$user->firstname}}">
                                </div>
                            </div>
                            <div class="mb-2 col-span-1">
                                <div class="mb-1">
                                ...
                                <div class="w-full">
                                    <input type="text" name="last_name" class="w-full bg-[#8e9bb2] p-2 rounded-xl" value="{{$user->lastname}}">
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-10">
                            ...
                            <div class="mb-2 col-span-1">
                                ...
                                <div class="w-full">
                                    <input type="text" name="phone" class="w-full bg-[#8e9bb2] p-2 rounded-xl" value="{{$user->phone}}">
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-10">
                            <div class="mb-2 col-span-1">
                                ...
                                <div class="w-full">
                                    <input type="text" name="address" class="w-full bg-[#8e9bb2] p-2 rounded-xl" value="{{$user->address}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            @if (session('success'))
                                <div class="flex justify-center mt-2">
                                    <p class="text-green-700 tracking-wide font-semibold">{{ session('success') }}</p>
                                </div>
                            @endif
                        </div>
                    </form>
                    ...
                    <form action="">
                        <div class="grid gap-2">
                            <div class="mb-2 col-span-1">
                                ...
                                <div class="w-full">
                                    <input type="text" name="password" class="w-full bg-[#8e9bb2] p-2 rounded-xl">
                                </div>
                            </div>
                            <div class="mb-2 col-span-1">
                                <div class="mb-1">
                                ...
                                <div class="w-full">
                                    <input type="text" name="c_password" class="w-full bg-[#8e9bb2] p-2 rounded-xl">
                                </div>
                            </div>
                        </div>
