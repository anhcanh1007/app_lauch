                ...
                <div class="flex flex-col">
                    @if (!$user->image)
                        <div class="flex justify-center">
                            <img src="{{ asset('images/avt.jpg') }}" alt="" class="w-20 h-20 rounded-full"
                                id="image_user">
                        </div>
                    @else
                        <div class="flex justify-center">
                            <img src="{{ asset('images/' . $user->image) }}" alt="" class="w-20 h-20 rounded-full"
                                id="image_user">
                        </div>
                    @endif
                    <div class="mt-3">
                        <form action="{{ route('user.add_avatar', [$user->id]) }}" method="POST" enctype="">
                            <div class="flex justify-center">
                                @csrf
                                <div class="mr-2">
                                    <label for="fileInput"
