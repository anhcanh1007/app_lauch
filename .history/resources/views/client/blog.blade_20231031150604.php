...
@section('main')
    <div class="bg-[#e9eef1] w-full px-32">
        ...
        <div class="w-full pt-20 pb-40">
            <div class="mt-6 flex flex-wrap justify-between">
                <div class="bg-[#222c31] text-white rounded-2xl w-[30%] mb-6 hover:-translate-y-3 duration-300">
                    <div>
                        <img src="{{ asset('images/default.png') }}" alt="">
                    </div>
                    <div class="bg-[#0f0f11] py-10 px-10">
                        <div>
                            <p class="">New / 13 Apr, 2023 10:46 PM</p>
                        </div>
                        <div>
                            <h1>Biggest Movers: DOGE Snaps Losing Streak as SOL Hits Fresh 6...</h1>
                        </div>
                    </div>
                </div>
            </div>
