            ...
            <form action="" class="flex justify-center items-center flex-col">
                <div class="w-3/4 mb-4">
                    <input type="text" placeholder="Your Name"
                        class="w-full border border-gray-800 px-3 py-2 text-xl text-black tracking-wide font-medium rounded-xl hover:border-green-900">
                </div>
                <div class="w-3/4 mb-4">
                ...
                <div class="w-3/4 mb-4">
                    <textarea name="" id="" cols="30" rows="5" placeholder="Your"
                        class="w-full border border-gray-800 px-3 py-2 text-xl text-black tracking-wide font-medium rounded-xl hover:border-green-900"></textarea>
                </div>
                <div>
