        ...
        <div class="flex justify-center items-center mt-10 mb-10">
            <div class="grid grid-row-4 gap-4 w-1/2">
                ...
                <div>
                    ...
                    <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone-tradex"
                        style="display: none">
                        <p class="list-disc">Minimum deposit amount: $50</p>
                ...
                <div>
                    ...
                    <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone-tradex"
                        style="display: none">
                        <p class="list-disc">Investors can deposit via: BTC, ETH, USDT, BUSD, BNB, Coinbase, Perfect Money</p>
                ...
                <div>
                    ...
                    <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone-tradex"
                        style="display: none">
                        <p class="list-disc">Main wallet: When investors make a deposit, they will transfer to this wallet or receive a referral bonus from a partner.</p>
