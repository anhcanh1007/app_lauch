<div class="h-20 bg-[#18172d] w-full px-28 text-white font-semibold font-mono fixed">
    <div class="grid grid-cols-3">
        ...
        <div class="col-span-2 flex justify-around items-center text-lg">
            ...
            <div>
                <a href="{{ route('dashboard') }}" class="hover:text-blue-500 duration-150 cursor-pointer">About Us</a>
            </div>
            <div>
                <a href="{{ route('dashboard') }}" class="hover:text-blue-500 duration-150 cursor-pointer">Bounty</a>
            </div>
            <div>
                <a href="{{ route('dashboard') }}" class="hover:text-blue-500 duration-150 cursor-pointer">F.A.Q</a>
            </div>
            <div>
