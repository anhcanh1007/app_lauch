        ...
        <div class="col-span-2 flex justify-around items-center text-lg">
            ...
            @if (auth()->user())
                <div class="flex text-[#d8eff6]">
                    <div class="absolute" onclick="">
                        <i class="fas fa-user" id="profile" onclick="toggleProfile()"></i>
                        <div class="p-4 border-2 rounded-lg border-dashed border-[#d8eff6]" style="display: none">
                            <div class="flex mb-2">
