        ...
        <div class="col-span-2 flex justify-around items-center text-lg">
            ...
            @if (auth()->user())
                <div class="flex text-[#d8eff6]">
                    <div class="absolute">
                        <button id="profile" onclick="toggleProfile()">
                            <i class="fas fa-user"></i>
                        </button>
                        <div class="p-4 border-2 rounded-lg border-dashed border-[#d8eff6]" id="div_profile">
                            <div class="flex mb-2">
...
@section('script')
    <script>
        let profile = false;
        let div_profile = document.getElementById
