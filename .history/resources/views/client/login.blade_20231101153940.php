            ...
            <div class="mt-4">
                <form action="">
                    <div class="mb-3">
                        ...
                        <input class="border border-gray-800 w-full rounded-xl text-xl px-5 py-2 hover:border-blue-900"
                            type="text" name="" placeholder="email / username">
                    </div>
                    <div>
                        <p class="text-xl mb-2">Your Password</p>
                        <input class="border border-gray-800 w-full rounded-xl text-xl px-5 py-2 hover:border-blue-900" type="text" name="" placeholder="Password">
                    </div>
                    <div>
                        <div>
