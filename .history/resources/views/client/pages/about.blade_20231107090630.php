    ...
    <div class="px-32 font-mono">
        ...
        <div class="mt-20 mb-20 px-20 text-black tracking-wide font-semibold">
            ...
            <div class="rounded-2xl border-solid border-2 border-gray-300 px-14 py-4" id="respone2-tradex"
                style="display: none">
                <li>Tradex10 is a legal company in New Zealand and is registered as Tradex Group Limited.</li>
                <li>Company number: 1262923</li>
                <li>Address: 14 Uretara Drive, Katikati 3129, New Zealand</li>
                <li>Email: info@tradex10.com</li>
            </div>
        </div>
    </div>
@endsection
