...
@section('main')
    <div class="bg-[#f7f8f8] w-full px-32">
        ...
        <div class="mt-5 flex justify-start">
            ...
            <div class="mr-3"><button class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300">Trustpilot</button></div>
            <div class="mr-3"><button class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300">Google</button></div>
