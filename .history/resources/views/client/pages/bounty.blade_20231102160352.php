    ...
    <div class="bg-[#f7f8f8] w-full px-32">
        ...
        <div class="mt-5 flex justify-start">
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300" onclick="showDiv2()">Youtube</button>
            </div>
            <div class="mr-3"><button
            ...
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300" onclick="showDiv2()">Google</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300" onclick="showDiv4()">GG
                    Map</button></div>
        </div>
        <div class="px-10 flex justify-between items-center mt-10 mb-20" id="button1">
            <div class="w-[30%] px-6">
                <div class="mb-3">
        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" style="display: none" id="button2">
            <div class="w-[30%] px-6">
                <div class="mb-3">
                    <h1 class="text-2xl tracking-wide font-medium">Bonus from $10 - $80</h1>
                </div>
        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" style="display: none" id="button3">
            <div class="w-[30%] px-6">
                <div class="mb-3">
                    <h1 class="text-2xl tracking-wide font-medium">Bonus from $10 - $80</h1>
                </div>
        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" style="display: none" id="button4">
            <div class="w-[30%] px-6">
                <div class="mb-3">
                    <h1 class="text-2xl tracking-wide font-medium">Bonus from $10 - $80</h1>
                </div>
