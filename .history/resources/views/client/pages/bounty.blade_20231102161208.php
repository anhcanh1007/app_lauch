        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" style="display: none" id="div2">
            ...
            <div class="px-10 flex justify-between items-center mt-10 mb-20" style="display: none" id="div3">
                <div class="w-[30%] px-6">
                    ...
                    <div>
                        <button
                            class="bg-[#7d47cb] px-4 py-2 text-base tracking-wide rounded-lg text-white hover:bg-[#528ebb] duration-200">Send Campaign File</button>
                    </div>
                </div>
                <div class="w-[30%] bg-[#0f0f11] px-6 py-4 rounded-2xl">
                    <div class="mb-3">
                ...
                <div class="w-[30%] px-6">
                    ...
                    <div class="mb-6">
                        <p>Requirements: meet bonus conditions. The amount of the reward depends on the content of your
                            account,
                            the number ofasfdasfasdfasfdae videos and texts in it.</p>
                    </div>
                    <div>
                        <button
                            class="bg-[#7d47cb] px-4 py-2 text-base tracking-wide rounded-lg text-white hover:bg-[#528ebb] duration-200">Start
