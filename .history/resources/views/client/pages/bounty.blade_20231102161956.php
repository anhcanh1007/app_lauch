...
@section('main')
    <div class="bg-[#f7f8f8] w-full px-32">
        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" id="div2">
            <div class="w-[30%] px-6">
                <div class="mb-3">
                    <h1 class="text-2xl tracking-wide font-medium">Bonus from $1 - $5</h1>
                </div>
                <div class="mb-6">
                    <p>You need to rate 5 stars on</p>
                    <p>trustpilot.com/review/tradex10.com</p>
                    <div>
                        <button
        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" id="div3">
            <div class="w-[30%] px-6">
                <div class="mb-3">
        ...
        <div class="px-10 flex justify-between items-center mt-10 mb-20" id="div4">
            <div class="w-[30%] px-6">
                <div class="mb-3">
