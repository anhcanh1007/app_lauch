    ...
    <div class="bg-[#f7f8f8] w-full px-32">
        ...
        <div class="mt-5 flex justify-start">
            <div class="mr-3"><button
                    ...
                    onclick="showDiv(1)" id="button1">Youtube</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300"
                    onclick="showDiv(2)" id="button2">Trustpilot</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300"
                    onclick="showDiv(3)" id="button3">Google</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#283046] duration-300"
                    onclick="showDiv(4)" id="button4">GG
                    Map</button></div>
        </div>
        <div id="div1">
    ...
    @section('script')
        <script>
            ...
            function showDiv(pram, buttonId) {
                ...
                const currentButton = document.getElementById('button' + currentDiv);
                const newButton = document.getElementById('button' + pram);
                document.getElementById('button').forEach(btn => {
