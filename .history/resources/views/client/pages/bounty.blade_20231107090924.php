...
@section('main')
    <div class="bg-[#f7f8f8] w-full px-32 font-serif">
        ...
        <div class="mt-5 flex justify-start">
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#528ebb] duration-300"
                    onclick="showDiv(1, 'button1')" id="button1">Youtube</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#528ebb] duration-300"
                    onclick="showDiv(2, 'button2')" id="button2">Trustpilot</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#528ebb] duration-300"
                    onclick="showDiv(3, 'button3')" id="button3">Google</button>
            </div>
            <div class="mr-3"><button
                    class="bg-[#1e1e1e] text-white text-base font-medium rounded-lg tracking-wide px-4 py-2 hover:bg-[#528ebb] duration-300"
                    onclick="showDiv(4, 'button4')" id="button4">GG
                    Map</button></div>
        </div>
        <div id="div1">
    ...
    @section('script')
        <script>
            ...
            function showDiv(pram, buttonId) {
                for (let i = 1; i <= 4; i++) {
                ...
                buttons.forEach(button => {
                    button.style.backgroundColor = '#1e1e1e'; // Đặt màu nền về màu mặc định
                });
                document.getElementById(buttonId).style.backgroundColor = '#528ebb'
                if (currentButtonId && currentButtonId !== buttonId) {
                    document.getElementById(currentButtonId).style.backgroundColor = '#1e1e1e';
                }
