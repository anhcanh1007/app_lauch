...
@section('main')
    <div class="w-full px-32 font-sans">
        ...
        <div class="mt-14 flex justify-around">
            <div class="bg-[#1e1e26] text-white rounded-xl px-10 py-10 grid grid-rows-3 gap-4 w-[30%]">
        ...
        <div class="mt-20">
            <form action="" class="flex justify-center items-center flex-col">
                ...
                <div class="mt-4 mb-10">
                    <button
                        class="bg-[#18172d] px-4 py-3 text-xl rounded-xl text-white tracking-wide font-semibold hover:bg-[#A2805E] duration-300">Submit
                        Now</button>
                </div>
            </form>
        </div>
