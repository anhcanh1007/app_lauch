...
Route::get('/verification-email', [RegisterController::class, 'get_code_verification_email'])->name('get_code_verification_email);
...
Route::group(['prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::get('/verifi-email/{$id}', [UserController::class, 'get_code_verification_email'])->name('get_code_verification_email');
});
