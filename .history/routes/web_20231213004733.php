...
Route::post('/create-user', [RegisterController::class, 'store'])->name('create_user');
Route::get('/forgot-password', [UserController::class, 'show_form_forgot_password'])->name('show_form_forgot_password');
Route::post('/forgot-password', [UserController::class, 'forgot_password'])->name()
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin', 'check_admin']], function () {
        ...
        Route::get('/list-user', [DashboardController::class, 'list_user'])->name('list_user');
    });
});
