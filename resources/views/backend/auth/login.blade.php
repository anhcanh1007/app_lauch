...
<body class="antialiased">
    <div class="h-screen w-full bg-cover pt-40 pl-36"
        ...
        <div class="p-20 w-1/3 h-auto bg-[#362e30] opacity-60 rounded-xl">
            ...
            <form action="{{ route('admin.login') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="text" name="email" class="w-full rounded-lg text-lg px-2 py-1" required>
                    </div>
                </div>
                <div class="mb-3">
                    <div>
                    ...
                    <div>
                        <input type="password" name="password" class="w-full rounded-lg text-lg px-2 py-1" required>
                    </div>
                </div>
                ...
                <div>
                    @if ($errors->has('login'))
                        <div class="bg-red-600 rounded-lg mt-3 p-4">
                            <p class="text-white tracking-wide font-semibold ">
                                {{ $errors->first('login') }}
                            </p>
                        </div>
                    @endif
